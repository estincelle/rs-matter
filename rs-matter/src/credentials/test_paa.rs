...
pub const TEST_PAA_FFF1_CERT: &[u8] = include_bytes!("test_data/Chip-Test-PAA-FFF1-Cert.der");

/// Expected SKID for TEST_PAA_FFF1_CERT.
pub const TEST_PAA_FFF1_SKID: [u8; 20] = [
...
pub const TEST_PAA_NOVID_CERT: &[u8] = include_bytes!("test_data/Chip-Test-PAA-NoVID-Cert.der");

/// Expected SKID for TEST_PAA_NOVID_CERT.
pub const TEST_PAA_NOVID_SKID: [u8; 20] = [
...
/// [`ArrayAttestationTrustStore::from_directory`] (std) or
/// [`ArrayAttestationTrustStore::from_certs`] with real PAA certificates.
pub fn test_paa_store() -> super::trust_store::ArrayAttestationTrustStore<2> {
